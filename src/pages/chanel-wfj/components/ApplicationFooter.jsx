    ...
    <footer className="w-full border-t border-[var(--cw-line)]">
      <div className="max-w-[120rem] mx-auto px-6 md:px-12 lg:px-16 py-12 md:py-14">
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between md:gap-16">
          <p className="font-['Outfit'] text-[11.5px] md:text-[12px] leading-[1.75] text-[var(--cw-muted)] max-w-[640px]">
            {DISCLAIMER}
          </p>
          ...
          <div className="flex flex-col gap-2 md:items-end shrink-0">
            <a
              ...
              className="font-['Outfit'] text-[11.5px] tracking-[0.06em] text-[var(--cw-ink-2)] hover:text-[var(--cw-ink)] transition-colors duration-300"
            >
              {CONTACT_EMAIL}
            </a>
            <span className="font-['Outfit'] text-[9.5px] tracking-[0.2em] uppercase text-[var(--cw-muted)]">
